...
<div className="row" style={{backgroundColor:"#F7F5F9"}}>
        <div className="col-lg-6" style={{backgroundColor:"#F7F5F9"}}>
          <div id="c1">
        <span className="herotext">Explore your <span style={{color:"#0096C8 "}}>hobby</span> or <span style={{color:"#8064A2 "}}>passion</span></span>
        <div className="d1">
        ...
        <div className="col-lg-6 hero" style={{backgroundColor:"#F7F5F9"}}>
          <div className="c2 a">
            ...
            <button>
            <FcGoogle style={{marginLeft:"10px",marginRight:"10px",top:"238px",position:"absolute"}}/> <span className="bb1">Continue with Google</span>
            </button>
            </div>
           <div style={{marginTop:"30px"}}>
            <button>
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>
                  <IoMdLock style={{marginLeft:"10px",marginRight:"10px",top:"495px",left:"1090px",position:"absolute",color:"#939CA3"}}/><span className="Remember1">Forgot Password?</span>
        ...
        <div className="col" >
          <div className="c2 aaa" style={{backgroundColor:"#F7F5F9",paddingTop:"0px"}}>
            <table>
              <tbody>
                <tr>
                  <td>
            ...
            <div style={{marginTop:"30px"}}>
            <button>
            <span className="ic1"><FcGoogle size={44} /></span><span className="bb1">Continue with Google</span>
            </button>
            </div>
           <div style={{marginTop:"30px"}}>
            <button>
...
<section>
    ...
    <div className="row">
      ...
      <Card className="card4" style={{borderRadius:"5px",border:"1px solid #8064A2"}}>
<div className="cd4" style={{paddingLeft:"15px"}}>
<Card.Body >
        <div className="card4Title" ><Card.Title><MdGroups className="ic2" size={30} style={{color:"#8064A2"}}/><span className="prod">People</span>
</Card.Title></div> 
        <div className="card4Text">
        <Card.Text>
        Find a teacher, coach, or expert for your hobby interest in your locality.  Find a partner, teammate, accompanist or collaborator.        </Card.Text>
      ...
      <div className="c41 col">
      <Card className="card4a" style={{borderRadius:"5px",border:"1px solid #8064A2"}}>
<div className="cd4" style={{paddingLeft:"15px"}}>
<Card.Body >
        <div className="card4Title" ><Card.Title><FaLocationDot size={30} className="ic2" style={{color:"#77933C"}}/> <span className="prod">Place</span>
</Card.Title></div> 
        <div className="card4Text">
        <Card.Text>
...
<div className="cd4" style={{paddingLeft:"15px"}}>
<Card.Body >
  <div className="card4Title" ><Card.Title><IoMdBasket size={30} className="ic2" style={{color:"#C0504D"}}/> <span className="prod">Product</span>
</Card.Title></div> 
  <div className="card4Text">
  <Card.Text>
...
<div className="cd4" style={{paddingLeft:"15px"}}>
<Card.Body >
  <div className="card4Title" ><Card.Title><BsFillCalendar2CheckFill  className="ic2" size={24} style={{position:"absolute",left:"35px",color:"#0096C8"}}/> <span className="prod">Program</span>
</Card.Title></div> 
  <div className="card4Text">
  <Card.Text>
        ...
        <div className="footer-container">
            ...
            <div className="footer-section">
                ...
                <div className="container">
                    <input type="text" className="input" placeholder="Email ID"/><button className="button">Invite</button>
                </div>
            </div>
        </div>
